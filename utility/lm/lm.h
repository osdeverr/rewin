...
struct Vec2
{
    ...
    inline Vec2 Left() const { return Vec2(-y, x); }
    inline Vec2 Right() const { return -Left(); }
...
struct Matrix4
{
	...
	inline static Matrix4 Scaling(float x, float y, float z)
	{
		return Matrix4(
			x, 0.f, 0.f, 0.f,
			0.f, y, 0.f, 0.f,
...
struct Rect2
{
	...
	Rect2(const Vec2& _v0, const Vec2& _v1) :
		v0(_v0), v1(_v1)
	{}

	inline Vec2 GetCenter() { return (v0 + v1) / 2.f; }
